	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 120,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: '/images/progress_bar/progressbg_green.gif'
				height			: 12,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: '/images/progress_bar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/images/progress_bar/progressbg_red.gif',
									30: '/images/progress_bar/progressbg_orange.gif',
									70: '/images/progress_bar/progressbg_green.gif'
								},
