class UsersController < ApplicationController
  ...
  EMAIL = "tom@gmail.com" # needed to access the APi
  PASSWORD = "123456789" # needed to access the APi
  API_BASE_URL = "http://localhost:3000/" # base url of the API


  def index
    uri = "#{API_BASE_URL}" # specifying json format in the URl
    rest_resource = RestClient::Resource.new(uri, EMAIL, PASSWORD) # It will create new rest-client resource so that we can call different methods of it
...
def create
 ...
 def show
    ...
    rest_resource = RestClient::Resource.new(uri, EMAIL, PASSWORD)
    debugger
